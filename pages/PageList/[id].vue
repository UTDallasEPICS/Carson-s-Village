  ...
  table(style="table-layout: auto;")
    thead
      tr
        ...
        th.font-poppins.font-bold.overflow-hidden(v-if="isAdmin || isAdvocate" style="color: white; width:15%;--tw-bg-opacity: 1; background-color: rgb(110 171 191 / var(--tw-bg-opacity));") User ID
      ...
      :class="{'bg-gray-200': (i+1) % 2}"
        ...
        td.font-poppins.text-gray-dark.font-bold(style="text-align: center;" v-if="isAdmin || isAdvocate") {{ item.userCuid }}
