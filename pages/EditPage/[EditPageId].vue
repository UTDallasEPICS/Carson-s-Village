...
description="Here, you select from photos you uploaded to show up at the top of the family page") 
            div(class="mx-9 sm:col-span-2 sm:mr-11")
                Listbox(id="profile_image" v-model="data.profileImageCuid" as="div" class="rounded-lg outline-0 w-full bg-white p-2") 
                    div(class="relative")
                        Transition(
                            leave-active-class='transition ease-in duration-300'
                            leave-from-class='opacity-100'
        ...
        div(class="py-4 grid sm:grid-cols-3")
            ...
            div(class="flex mx-9 sm:col-span-2 sm:mr-11")
                ...
                input(v-model='data.donation_goal' class="outline-0 rounded-r-md border-box w-full p-2 border border-[#c4c4c4]")
        div(class="py-4 grid sm:grid-cols-3")
        ...
        div(class="ml-9 mb-9 py-7 flex flex-wrap gap-2")
            ...
            div(class="py-2 mt-2")
                LinkButton(v-if="pageCuid!=0" :to="`/Page/${cuid}`" class="sm:my-2 transition duration-300 bg-orange-999 hover:bg-green-600") View Page
            div(class="p-2 pt-6 mt-2 sm:pt-2 sm:ml-auto sm:mr-6")
                LinkButton(v-if="pageCuid!=0" to='#' class="sm:my-2 transition duration-300 bg-orange-999 hover:bg-green-600") Delete Page
