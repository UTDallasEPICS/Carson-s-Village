...
INSERT INTO "new_Family" ("advocate_cuid", "created_at", "deactivatedAt", "family_name", "id", "isActive", "stripe_account_id", "updated_at") SELECT "advocate_cuid", "created_at", "deactivatedAt", "family_name", "id", "isActive", "stripe_account_id", "updated_at" FROM "Family";
DROP TABLE "Family";
