...
export const loginRedirectUrl = () => `${runtime.ISSUER}/authorize?response_type=code&response_mode=form_post&client_id=${runtime.AUTH0_CLIENTID}&scope=openid%20email&redirect_uri=${encodeURIComponent(runtime.BASEURL!+"/api/callback")}&nonce=${genState()}`
