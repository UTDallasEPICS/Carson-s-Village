...
export const logoutRedirectUrl = (id_token: string) => `${process.env.ISSUER}/oidc/logout?id_token_hint=${id_token}&post_logout_redirect_uri=${encodeURIComponent(process.env.BASEURL!+"/api/login")}&nonce=${genState()}`
