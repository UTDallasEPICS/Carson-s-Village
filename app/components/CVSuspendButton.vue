...
<template lang="pug">
svg(v-if="rep.suspended && rep.reply.length > 0" @click="pushUnsuspend()" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="inline w-6 h-6") 
...
svg(v-if="!rep.suspended && rep.reply.length > 0" @click="pushSuspend()" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="inline w-6 h-6")
