...
<template>
  <div class="information rounded-md mx-9 my-2 text-center sm:text-start text-white bg-blue-999">
    <CVLegend>Images</CVLegend>
  </div>
  <div class="grid py-4 ml-10 sm:grid-cols-3">
    <a class="pt-1 sm:ml-3 drop-shadow-[3px_3px_4px_rgba(0,0,0,0.25)]">
      Image Upload
      <ImageUpload
        :page-cuid="props.pageCuid"
        @imageUploaded="saveImage"
      />
    </a>
  </div>
  <div
      ...
      <div class="flex overflow-x-auto">
        ...
        >
          ...
          <div class="form-horizontal absolute top-2.5 right-5">
            <button
              class="bg-red-500 flex items-center justify-center leading-loose text-center text-white font-light absolute top-0 left-0 w-[30px] h-8 rounded-full pb-1"
